...
export function hideShowNavi() {
    const navi = document.getElementById('newNavi');
    const naviLogoHam = document.getElementById('naviLogoHam');
    ...
    const statusItemsArray = statusItems.querySelectorAll('.nav-link.ptr');
