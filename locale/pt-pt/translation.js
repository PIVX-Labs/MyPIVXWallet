export const pt_pt_translation = {
    ...
    doNotShareWarning:
        'Qualquer pessoa com uma cópia dela pode acessar <b> a todos</b> os seus fundos', //Anyone with a copy of it can access <b>all</b> of your funds.
    ...
    pivxPromos:
        'um sistema descentralizado de códigos de presente no valor de PIV', // [...] is a decentralised system for gift codes worth PIV
    ...
    contestedProposalsDesc:
        'Essas são as propostas que receberam uma quantidade esmagadora de votos negativos, tornando-as provavelmente spam ou uma proposta altamente contestável.', //These are proposals that received an overwhelming amount of downvotes, making it likely spam or a highly contestable proposal.
